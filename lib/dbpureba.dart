...
class DB {
  static Future<Database> _openDB() async {
    ...
    return openDatabase(join(dbPath, 'grafos.db'), onCreate: (db, version) {
      db.execute(
        'CREATE TABLE GRAFOS(id INTEGER PRIMARY KEY,Nombre TEXT, Descripcion TEXT, Nodos TEXT, Lineas Text, cantidadNodos INTEGER, cantidadLineas INTEGER)',
      );
    }, version: 1);
  }
